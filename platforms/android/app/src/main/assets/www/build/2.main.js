...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__books_page__ = __webpack_require__(601);
...
BooksPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-books-page',template:/*ion-inline-start:"/Users/fabianzapata/Documents/Applications/Movil/Movil-Alianza/src/pages/books-page/books-page.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>    \n    <ion-title>{{ \'page.books.list\' | translate }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <button ion-button block (click)="openPage(\'BookAddPage\')">{{ \'button.add_book\' | translate }}</button>\n  \n  <ion-list *ngIf="books">\n    <button ion-item  *ngFor="let book of books" (click)="bookInfo(book)">{{ book.title }}</button>\n  </ion-list>\n  \n</ion-content>\n'/*ion-inline-end:"/Users/fabianzapata/Documents/Applications/Movil/Movil-Alianza/src/pages/books-page/books-page.html"*/,
    }),
