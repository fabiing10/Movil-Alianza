...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__blogs__ = __webpack_require__(597);
...
BlogsPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__blogs__["a" /* BlogsPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__blogs__["a" /* BlogsPage */]
        ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__post_post__ = __webpack_require__(596);
...
var BlogsPage = (function () {
    function BlogsPage(navCtrl, navParams, http, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.http = http;
        this.modalCtrl = modalCtrl;
        this.url = 'https://alianzaparaelprogreso.co/wp-json/wp/v2/posts';
    }
    ...
    BlogsPage.prototype.goToPost = function (item) {
        var myModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_2__post_post__["a" /* PostPage */], { item: item });
        myModal.present();
    };
    return BlogsPage;
}());
BlogsPage = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPage */])(),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-blogs',template:/*ion-inline-start:"/Users/fabianzapata/Documents/Applications/Movil/Movil-Alianza/src/pages/blogs/blogs.html"*/'<!--\n  Generated template for the BlogsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Blogs</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <img src="../../assets/images/contacto_movil.jpg"/>\n  <ion-card  *ngFor="let item of items">\n      <img src="https://alianzaparaelprogreso.co/wp-content/uploads/{{item.better_featured_image.media_details.file}}"/>\n      <div class="card-title">{{item.title.rendered}}</div>\n\n    </ion-card>\n\n</ion-content>\n'/*ion-inline-end:"/Users/fabianzapata/Documents/Applications/Movil/Movil-Alianza/src/pages/blogs/blogs.html"*/,
    }),
