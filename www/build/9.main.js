...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__forgot_page__ = __webpack_require__(598);
...
ForgotPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-forgot-page',template:/*ion-inline-start:"/Users/fabianzapata/Documents/Applications/Moviles/Ionic/Movil-Alianza/src/pages/forgot-page/forgot-page.html"*/'<ion-header>\n\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>       \n    <ion-title>{{ \'page.forgotten_password\' | translate }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-grid>\n    <ion-row justify-content-around>\n      <ion-col col-sm-6 col-md-6 col-lg-4 col-xl-3  align-self-center>\n        <form [formGroup]="forgotData" (ngSubmit)="login()">\n          <ion-item>\n            <ion-label floating>{{ \'label.email\' | translate }}:</ion-label>\n            <ion-input type="email" formControlName="email"></ion-input>\n          </ion-item>\n\n          <button margin-top ion-button type="submit" [disabled]="!forgotData.valid">{{ \'button.submit\' | translate }}</button>\n\n        </form>\n\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>\n'/*ion-inline-end:"/Users/fabianzapata/Documents/Applications/Moviles/Ionic/Movil-Alianza/src/pages/forgot-page/forgot-page.html"*/,
    }),
